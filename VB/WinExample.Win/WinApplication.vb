...
Namespace WinExample.Win
	Partial Public Class WinExampleWindowsFormsApplication
		...
		Private Sub WinExampleWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
